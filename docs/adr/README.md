...
| [ADR-007](0007-auth-at-gateway.md) | Личность в user-house, доступ = членство, проверяет Gateway | Accepted |
| [ADR-008](0008-user-house-membership.md) | User — House N:N через HouseMember | Accepted |
